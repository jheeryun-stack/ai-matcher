...
function initSphereAnimation() {
  ...
  context.font = '500 70px "Futura PT", Futura, sans-serif'; // Smaller font to fit inside sphere
  ...
  centerTextSprite.scale.set(1.2, 0.28, 1); // Smaller scale to fit inside 0.4 radius sphere
