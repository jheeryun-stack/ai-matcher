...
function initSphereAnimation() {
  ...
  context.font = '500 100px "Futura PT", Futura, sans-serif'; // Smaller font to fit inside sphere
  ...
  centerTextSprite.scale.set(1.8, 0.42, 1); // Smaller scale to fit inside 0.6 radius sphere
...
if (aboutButton) {
  ...
  aboutButton.addEventListener('click', (e) => {
    ...
    } else if (e.target.textContent === 'about' || e.target.closest('span:not(.traffic-button):not(.funnews-button):not(.aigallery-button)')) {
      showMatchSection();
    }
  });
